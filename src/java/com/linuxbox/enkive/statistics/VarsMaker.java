...
/**
 * This class holds methods that are useful in the creation of many common variable 
 * types being used in the statistics package. It exists in order to allow someone 
 * to change the datatypes (ie. LinkedList to ArrayList) of many variables if another 
 * one is found more suitable.
 */
