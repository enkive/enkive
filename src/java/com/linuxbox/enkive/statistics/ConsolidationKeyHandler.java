...
public class ConsolidationKeyHandler {
	...
	/**
	 * @param keyPath is a string containing the following information:
	 * 
	 * The path to the data (ie. *.*.totalMemory)
	 * The consolidation methods !separated by commas! (ie. max,min,avg)
	 * NOTE: methods can be left blank, but that should only be used for variables
	 * that DO NOT need consolidation (ie. collection name)
	 * The Human Readable Name (ie. Total RAM Memory Used)
	 * The Units (Optional): (ie. bytes)
	 * The statistic type (ie. point)
	 * 
	 * separated by colons ':' and formatted like so:
	 * 
	 * <path to the data>:<consolidation methods>:<human readable name>:<units>:<statistic type>
	 * 
	 * Example:
	 * "*.*.TotalMemory:max,min,avg:Total RAM Memory Used:Bytes:point"
	 * 
	 * The asterisks in the path to the data indicate that the variableName is embedded 
	 * a level farther down in the Map. The consolidation method names indicate which 
	 * consolidations to keep for this statistic.
	 */
	...
	/**
	 * @return a colletion containing strings that define which consolidation(s) to do
	 * for this statistic 
	 */
	...
	/**
	 * @param str is parsed to define the following information:
	 * 
	 * The path to the data (ie. *.*.totalMemory)
	 * The consolidation methods !separated by commas! (ie. max,min,avg)
	 * The Human Readable Name (ie. Total RAM Memory Used)
