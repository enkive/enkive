...
public class MongoWorkspaceConstants {

	public static String UUID = "_id";

	// UserWorkspace Constants
	public static String ACTIVEWORKSPACE = "ActiveWorkspace";
	public static String WORKSPACELIST = "Workspaces";
