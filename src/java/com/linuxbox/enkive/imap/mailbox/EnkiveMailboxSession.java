...
public class EnkiveMailboxSession extends SimpleMailboxSession {
	...
	public EnkiveMailboxSession(final long sessionId, final String userName,
			final String password, final Logger log,
			final List<Locale> localePreferences, char pathSeparator,
			SessionType type, Workspace workspace,
			MailboxEventDispatcher<String> dispatcher) {

		super(sessionId, userName, password, log, localePreferences,
