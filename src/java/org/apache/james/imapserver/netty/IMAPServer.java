...
public class IMAPServer extends AbstractConfigurableAsyncServer implements ImapConstants, IMAPServerMBean, NettyConstants {
    ...
    protected class ImapChannelPipelineFactory implements ChannelPipelineFactory,
    	...
    	ImapChannelPipelineFactory(ChannelGroup group) {
    		groupHandler = new ChannelGroupHandler(group);
    ...
    protected ChannelPipelineFactory createPipelineFactory(final ChannelGroup group) {
        return new ImapChannelPipelineFactory(group);
    }
